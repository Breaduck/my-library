    ...
    <div className="min-h-screen bg-[#F5F5F7]">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 pt-6 sm:pt-12"
        ...
        <div className="flex items-center gap-3 mb-8">
          <Link href="/" className="flex items-center justify-center w-11 h-11 sm:w-9 sm:h-9 rounded-full bg-white hover:bg-gray-50 active:bg-gray-100 transition-colors flex-shrink-0"
                  ...
                  <div className="mt-4 space-y-2">
                    ...
                    {calMonthDayBooks[selectedDay].map((book) => (
                      <Link key={book.id} href={`/book/${book.id}`}
                        ...
                        <div className="w-9 h-13 rounded-lg overflow-hidden flex-shrink-0" style={{ height: 48 }}>
                          {book.coverUrl
