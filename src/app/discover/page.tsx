  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7]">
      ...
      <div className="sm:hidden fixed bottom-0 left-0 right-0 flex items-center justify-around px-5 py-3 bg-[#F5F5F7]/90 backdrop-blur-md border-t border-black/5"
        ...
        <Link href="/" className="flex flex-col items-center gap-0.5 text-[#6E6E73] active:opacity-60 transition-opacity">
        ...
        <Link href="/discover" className="flex flex-col items-center gap-0.5 text-[#1D1D1F] active:opacity-60 transition-opacity">
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
