    ...
    <div className="fixed inset-0 bg-black/40 flex items-end sm:items-center justify-center z-50"
      ...
      <div className="bg-white w-full sm:max-w-sm rounded-t-3xl sm:rounded-3xl p-6 sm:p-7"
        ...
        <div className="space-y-2">
          ...
          <button disabled
            className="w-full flex items-center justify-center gap-3 py-3.5 rounded-2xl bg-white text-[#AEAEB2] text-sm font-semibold border border-[#E5E5EA] cursor-not-allowed">
          ...
          <button disabled
            className="w-full flex items-center justify-center gap-3 py-3.5 rounded-2xl bg-white text-[#AEAEB2] text-sm font-semibold border border-[#E5E5EA] cursor-not-allowed">
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M12 3C6.48 3 2 6.62 2 11.04c0 2.86 1.87 5.37 4.69 6.78-.21.76-.74 2.7-.85 3.12-.14.52.19.51.4.37.16-.11 2.6-1.77 3.65-2.49.71.1 1.44.16 2.11.16 5.52 0 10-3.62 10-8.04C22 6.62 17.52 3 12 3z"/></svg>
            Kakao (곧 지원)
          </button>
        </div>
